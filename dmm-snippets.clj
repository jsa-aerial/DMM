...
;;; the addendum to caveat 1 we've just committed ("caveat 1
...
(rec-map-sum (rec-map-lin-comb testmask testmap)
...
;;; provisional version of down-movement (UNTESTED, need to
;;; define "accum" before it might work)
